# PowerShell script to fix the main.tf file
...
# Create a cleaned up version of main.tf
$cleanMainTf = @'
...
# Write the clean main.tf file
Set-FileContent -Path $mainTfPath -Content $cleanMainTf

Write-Host "The main.tf file has been fixed successfully!"
Write-Host "The script removed the duplicated/corrupted OTP service section and formatted the file properly."
Write-Host "The Redis module has been completely removed and replaced with MSG91 for OTP service."